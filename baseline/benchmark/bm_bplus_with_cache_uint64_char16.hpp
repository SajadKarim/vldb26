#ifndef BM_BPLUS_WITH_CACHE_UINT64_CHAR16_HPP
#define BM_BPLUS_WITH_CACHE_UINT64_CHAR16_HPP
...
namespace bm_bplus_with_cache_uint64_char16 {
...
typedef DataNode<KeyType, ValueType, ObjectUIDType, TYPE_UID::DATA_NODE_UINT64_CHAR16> DataNodeType;
typedef IndexNode<KeyType, ValueType, ObjectUIDType, DataNodeType, TYPE_UID::INDEX_NODE_UINT64_CHAR16> IndexNodeType;
...
std::vector<BenchmarkResult> run_benchmark_configuration(
    ...
    for (int run = 0; run < runs; ++run) {
        ...
        BenchmarkResult result("BPlusStore", cache_type_name, storage_type_name, cache_percentage, cache_size,
                              "uint64_t", "char16", operation, degree, records, run + 1, 
...
void test_with_shell_parameters(
    ...
    std::cout << "=== BPlusStore Cache Benchmark Suite (uint64_t->char16) ===" << std::endl;
...
void test_single_configuration(
    ...
    std::cout << "=== Single BPlusStore Configuration Test (uint64_t->char16) ===" << std::endl;
...
#endif // BM_BPLUS_WITH_CACHE_UINT64_CHAR16_HPP